/*
  Maximum Power Point Tracking - Simple Large 
  ...
  size which is very large. This large step size
  helps the converter reach maximum power point very
  fast.
...
int steps = 8; // step size of the PWM values if the operating point of the solar cell is such that V_(solar) < V_(mpp)
